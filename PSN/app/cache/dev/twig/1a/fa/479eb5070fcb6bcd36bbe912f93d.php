...
class __TwigTemplate_1afa479eb5070fcb6bcd36bbe912f93d extends Twig_Template
{
...
" => "<br />")), "html");
            ...
            echo (((0 == $this->getContext($context, 'count', '8'))) ? ("display") : ("hidden"));
            echo "\" />
                <img class=\"toggle\" id=\"icon_traces_";
            // line 9
            ...
            echo "\" style=\"visibility: ";
            echo (((0 == $this->getContext($context, 'count', '9'))) ? ("hidden") : ("display"));
    ...
    <ol class=\"traces list_exception\" id=\"traces_";
        ...
        echo "\" style=\"display: ";
        echo (((0 == $this->getContext($context, 'count', '18'))) ? ("block") : ("none"));
        echo "\">
        ";
        // line 19
