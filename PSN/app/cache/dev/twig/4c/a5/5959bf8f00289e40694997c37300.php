...
class __TwigTemplate_4ca55959bf8f00289e40694997c37300 extends Twig_Template
{
    ...
    <ol class=\"traces list_exception\" id=\"traces_";
        ...
        foreach ($context['_seq'] as $context['i'] => $context['trace']) {
            ...
            if ($template instanceof Twig_Template) {
                $template->display(array("prefix" => $this->getContext($context, 'position'), "i" => $this->getContext($context, 'i'), "trace" => $this->getContext($context, 'trace')));
            } else {
                echo $this->env->getExtension('templating')->getTemplating()->render($template, array("prefix" => $this->getContext($context, 'position'), "i" => $this->getContext($context, 'i'), "trace" => $this->getContext($context, 'trace')));
            }
            // line 22
            echo "            </li>
        ";
