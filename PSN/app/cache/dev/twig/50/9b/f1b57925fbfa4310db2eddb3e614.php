...
class __TwigTemplate_509bf1b57925fbfa4310db2eddb3e614 extends Twig_Template
{
    protected $parent;
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, 'collector', '30'), "logs", array(), "any", false, 30)) {
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['log']) {
                ...
                if ((("ERR" == $this->getAttribute($this->getContext($context, 'log', '33'), "priorityName", array(), "any", false, 33)) || ("ERROR" == $this->getAttribute($this->getContext($context, 'log', '33'), "priorityName", array(), "any", false, 33)))) {
                    echo " error";
                }
                echo "\">
                    ";
                // line 34
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'log', '34'), "message", array(), "any", false, 34), "html");
                echo "
                </li>
            ";
                ++$context['loop']['index0'];
