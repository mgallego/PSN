...
class __TwigTemplate_7840d0f9dd315d5bc993ceccc1e4b8ee extends Twig_Template
{
    protected $parent;
...
";
    ...
    ";
            ...
            // line 28
            echo "        ";
            echo $this->env->getExtension('templating')->renderAction("WebProfilerBundle:Exception:show", array("exception" => $this->getAttribute($this->getContext($context, 'collector', '28'), "exception", array(), "any", false, 28), "format" => "html"), array());
            // line 29
            echo "    ";
        }
    }
