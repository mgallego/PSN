...
class __TwigTemplate_87b9e0c96d7a7ae37a39126d4c8e9e16 extends Twig_Template
{
    ...
    <div class=\"block_exception\">
        ...
        echo "\"/>
                ...
                <h1>
                    ";
        // line 15
        echo $this->env->getExtension('templating')->formatFileFromText(twig_strtr($this->getAttribute($this->getContext($context, 'exception'), "message", array(), "any", false), array("
" => "<br />")));
        echo "
                </h1>
        ...
        echo "
                ...
                ";
        // line 22
        $context['previous_count'] = twig_length_filter($this->env, $this->getAttribute($this->getContext($context, 'exception'), "previouses", array(), "any", false));
        // line 23
        echo "                ";
        if ($this->getContext($context, 'previous_count')) {
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'exception'), "previouses", array(), "any", false));
            foreach ($context['_seq'] as $context['i'] => $context['previous']) {
                // line 27
                echo "                                <li>
                                    ";
                // line 28
                echo $this->env->getExtension('templating')->abbrClass($this->getAttribute($this->getContext($context, 'previous'), "class", array(), "any", false));
    ...
    ";
        ...
        foreach ($context['_seq'] as $context['position'] => $context['e']) {
            ...
            if ($template instanceof Twig_Template) {
                $template->display(array("exception" => $this->getContext($context, 'e'), "position" => $this->getContext($context, 'position'), "count" => $this->getContext($context, 'previous_count')));
            } else {
                echo $this->env->getExtension('templating')->getTemplating()->render($template, array("exception" => $this->getContext($context, 'e'), "position" => $this->getContext($context, 'position'), "count" => $this->getContext($context, 'previous_count')));
            }
            // line 45
            echo "    ";
        }
    ...
    ";
        ...
        if ($this->getContext($context, 'logger')) {
            ...
            if ($template instanceof Twig_Template) {
                $template->display(array("logs" => $this->getAttribute($this->getContext($context, 'logger'), "logs", array(), "any", false)));
            } else {
                echo $this->env->getExtension('templating')->getTemplating()->render($template, array("logs" => $this->getAttribute($this->getContext($context, 'logger'), "logs", array(), "any", false)));
            }
            // line 72
            echo "            </div>
