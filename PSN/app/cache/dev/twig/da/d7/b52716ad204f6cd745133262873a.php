...
class __TwigTemplate_dad7b52716ad204f6cd745133262873a extends Twig_Template
{
...
<div class=\"sf-toolbarreset\"
    ...
    ";
        ...
        foreach ($context['_seq'] as $context['name'] => $context['template']) {
            // line 28
            echo "        ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'template', '28'), "renderblock", array("toolbar", array("collector" => $this->getAttribute($this->getContext($context, 'profiler', '29'), "get", array($this->getContext($context, 'name', '29'), ), "method", false, 29), "profiler_url" => $this->getContext($context, 'profiler_url', '30'), "token" => $this->getAttribute($this->getContext($context, 'profiler', '31'), "token", array(), "any", false, 31), "name" => $this->getContext($context, 'name', '32'), "verbose" => $this->getContext($context, 'verbose', '33')), ), "method", false, 28), "html");
            // line 35
            echo "
    ";
        }
    ...
    ";
        // line 38
        if (("normal" != $this->getContext($context, 'position', '38'))) {
            // line 39
