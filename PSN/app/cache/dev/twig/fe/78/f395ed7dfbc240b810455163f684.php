...
class __TwigTemplate_fe78f395ed7dfbc240b810455163f684 extends Twig_Template
{
    protected $parent;
    ...
    public function display(array $context, array $blocks = array())
    {
        ...
        // line 3
        $context['__internal_fe78f395ed7dfbc240b810455163f684_1'] = $this;
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
            ...
            echo "</code></td>
                <td><code>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_fe78f395ed7dfbc240b810455163f684_1'], "display_listener", array($this->getContext($context, 'listener', '23'), ), "method", false, 23), "html");
            echo "</code></td>
            </tr>
        ";
        }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['listener']) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 39
                echo twig_escape_filter($this->env, $this->getAttribute($context['__internal_fe78f395ed7dfbc240b810455163f684_1'], "display_listener", array($this->getContext($context, 'listener', '39'), ), "method", false, 39), "html");
                echo "</code></td>
                </tr>
            ";
            }
