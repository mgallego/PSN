...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/moises/Desarrollo/PSN/PSN/app/cache/prod/assetic/config'), true)));
        ...
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/home/moises/Desarrollo/PSN/PSN/app/Resources/AcmeDemoBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/home/moises/Desarrollo/PSN/PSN/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Assetic\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PSNMainBundle', '/home/moises/Desarrollo/PSN/PSN/app/Resources/PSNMainBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PSNMainBundle', '/home/moises/Desarrollo/PSN/PSN/src/PSN/MainBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($a), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ClassMapCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router.real')), 3 => new \Symfony\Bundle\DoctrineBundle\CacheWarmer\ProxyCacheWarmer($this), 4 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetWriterCacheWarmer($a, new \Assetic\AssetWriter('/home/moises/Desarrollo/PSN/PSN/app/../web'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->setSQLLogger(new \Symfony\Bundle\DoctrineBundle\Logger\DbalLogger($this->get('monolog.logger.doctrine')));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, array(0 => '/home/moises/Desarrollo/PSN/PSN/src/Acme/DemoBundle/Entity')), 'Acme\\DemoBundle\\Entity');
        ...
        $f->setProxyDir('/home/moises/Desarrollo/PSN/PSN/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/moises/Desarrollo/PSN/PSN/app/logs/prod.log', 100, false);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/home/moises/Desarrollo/PSN/PSN/app/cache/prod', 'appprodUrlMatcher', 'appprodUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/home/moises/Desarrollo/PSN/PSN/app/config/routing.yml', array('cache_dir' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appprodUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appprodUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Acme\\DemoBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->registerPlugin(new \Symfony\Bundle\SwiftmailerBundle\Logger\MessageLogger());
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\StaticExtension($this->get('assetic.asset_factory'), true));
    ...
    {
        return $this->services['security.authentication.manager'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.main'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'))));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Component\Security\Core\User\EntityUserProvider($this->get('doctrine.orm.default_entity_manager'), 'AcmeDemoBundle:User', 'username');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod',
            ...
            'routing.resource' => '/home/moises/Desarrollo/PSN/PSN/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/home/moises/Desarrollo/PSN/PSN/app/cache/prod/assetic',
