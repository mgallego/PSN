...
class __TwigTemplate_2170c97f528efd69ca5280b0671bb9d7 extends Twig_Template
{
...
<html>
    ...
    <body>
        ...
        echo "\" alt=\"Symfony\">
            ...
            ";
        // line 22
        if ($this->getAttribute($this->getAttribute((isset($context['app']) ? $context['app'] : null), "session", array(), "any", false, 22), "flash", array("notice", ), "method", false, 22)) {
            // line 23
            echo "                <div class=\"flash-message\">
                    <em>Notice</em>: ";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context['app']) ? $context['app'] : null), "session", array(), "any", false, 24), "flash", array("notice", ), "method", false, 24), "html");
            echo "
                </div>
            ";
        }
