...
class __TwigTemplate_7ca468c8854bf7c8a24716cfcb700458 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ((isset($context['error']) ? $context['error'] : null)) {
            // line 5
            echo "    <div>";
            echo twig_escape_filter($this->env, (isset($context['error']) ? $context['error'] : null), "html");
            echo "</div>
";
        }
        // line 7
...
<form action=\"";
    ...
    <input type=\"text\" id=\"username\" name=\"_username\" value=\"";
        // line 10
        echo twig_escape_filter($this->env, (isset($context['last_username']) ? $context['last_username'] : null), "html");
        echo "\" />
